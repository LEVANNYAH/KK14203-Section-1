...
class LoginPanel extends JPanel {
   ...
   public LoginPanel(JFrame frame, Login login) {
      ...
      lbl_info = new JLabel ("To login, use Username: Admin and Password: Admin");
      ...
      btnLogin.setBounds (185, 80, 80, 25);
      lbl_username.setBounds (10, 20, 80, 25);
      lbl_password.setBounds (10, 50, 80, 25);
      username.setBounds (100, 20, 165, 25);
      password.setBounds (100, 50, 165, 25);
      lbl_info.setBounds (10, 110, 320, 25);
   
      //handle button action listener
      btnLogin.addActionListener(new ActionListener(){  
         public void actionPerformed(ActionEvent e){
            boolean status = false;
            if(!username.getText().equals("") && username.getText().equals("Admin") && !password.getText().equals("") && password.getText().equals("Admin"))
