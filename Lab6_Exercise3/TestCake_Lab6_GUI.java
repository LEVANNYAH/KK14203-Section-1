...
public class TestCake_Lab6_GUI extends JPanel implements ActionListener{
    ...
    public TestCake_Lab6_GUI() {
        //construct preComponents
        String[] jcbItems = {"[Select]"};

        //construct components
        jcomp1 = new JLabel ("Generic Cake Menu");
   ...
   public static void main (String[] args) {
      ...
      TestCake_Lab6_GUI capp = new TestCake_Lab6_GUI(); 
